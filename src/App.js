...
const App = () => {
	...
	return (
		<div className="h-screen bg-[#9e78ff] flex flex-col items-center justify-center">
			<h1 className="text-3xl md:text-5xl mx-6 mb-20">Rock, Paper and Scissors Game</h1>
